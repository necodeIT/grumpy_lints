...
| [models_must_have_model_suffix](#models_must_have_model_suffix) | A models declaration must have a name that ends with "Model" to ensure proper identification within the modular framework. | WARNING | Yes | ✅ |
